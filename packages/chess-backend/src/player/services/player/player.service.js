...
var PlayerService = /** @class */ (function () {
    ...
    PlayerService.prototype.createPlayer = function (player) {
        return (0, rxjs_1.from)(this.playerDetailRepository.save(player));
    };
    PlayerService.prototype.getPlayer = function () {
        return (0, rxjs_1.from)(this.playerDetailRepository.find());
    };
    PlayerService.prototype.getPlayerById = function (id) {
        return (0, rxjs_1.from)(this.playerDetailRepository.findOneBy({ id: id }));
    };
    ...
    PlayerService.prototype.updatePlayerById = function (playerDetailDto) {
        return __awaiter(this, void 0, void 0, function () {
            var playerDetailToUpdate, error_1;
